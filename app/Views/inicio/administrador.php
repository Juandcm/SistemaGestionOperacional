...
<div class="row">
	<div class="col-lg-12 col-xl-12 col-md-12">
		<div class="card">
			<div class="card-body">
				<h2 class="text-center">Bienvenido Usuario Administrador</h2>
				...
				<div class="container">
					<div class="row justify-content-center align-content-center">
						...
						<div class="col-lg-4 col-xl-4 col-md-4 text-center mt-2">
							<a href="<?= base_url() ?>/usuarios" class="card text-white bg-info card-hover waves-effect waves-light">
								<div class="card-header">
									<h4 class="m-b-0 text-white text-center">Administrar Usuarios</h4>
								</div>
							</a>
						</div>
