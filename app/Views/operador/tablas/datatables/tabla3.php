<div class="col-12 d-none" id="datatables-tabla-3">
	<div class="card">
		<div class="card-header">
			<h4 class="float-left">Tabla <span class="numerodatatabla-3"></span></h4>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="table-responsive d-none" id="tabla-responsive-3">
						<div class="mt-4 mb-4 text-justify textousuariostabla">
						</div>
							<table id="tabla-3-datatable" class="table table-striped table-bordered display row-border order-column nowrap table-hover table-info" style="width:100%">
