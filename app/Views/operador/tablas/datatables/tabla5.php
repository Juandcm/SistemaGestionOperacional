<div class="col-12 d-none" id="datatables-tabla-5">
	<div class="card">
		<div class="card-header">
			<h4 class="float-left">Tabla <span class="numerodatatabla-5"></span></h4>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-4">
						<div class="input-group mb-3 border-dark">
							<input type='text' class="form-control border-dark" name="fechatabla5" id="fechatabla5" />
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="table-responsive d-none" id="tabla-responsive-5">
							<div class="mt-4 mb-4 text-justify textousuariostabla">
							</div>
							<table id="tabla-5-datatable" class="table table-striped table-bordered display row-border order-column nowrap table-hover table-info" style="width:100%">
