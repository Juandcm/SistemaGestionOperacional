<div class="col-12 d-none" id="datatables-tabla-2">
	<div class="card">
		<div class="card-header">
			<h4 class="float-left">Tabla <span class="numerodatatabla-2"></span></h4>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-4">
						<div class="input-group mb-3 border-dark">
							<input type='text' class="form-control border-dark" name="fechatabla2" id="fechatabla2" />
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="table-responsive d-none" id="tabla-responsive-2">
						<div class="mt-4 mb-4 text-justify textousuariostabla">
						</div>
							<table id="tabla-2-datatable" class="table table-striped table-bordered display row-border order-column nowrap table-hover table-info" style="width:100%">
