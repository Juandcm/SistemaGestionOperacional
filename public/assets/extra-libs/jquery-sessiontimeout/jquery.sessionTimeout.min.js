! function(e) {
    ...
    e.sessionTimeout = function(t) {
        function o() { f || (e.ajax({ type: d.ajaxType, url: d.keepAliveUrl, data: d.ajaxData,dataType: "json", success: function (data) { $("#usuario_inicio_session").text(data.usuario_inicio_session) }}), f = !0
            // setTimeout(function() { f = !1 }, d.keepAliveInterval)
            )}

    function i() { 
        clearTimeout(a), (d.countdownMessage || d.countdownBar) && s("session", !0), "function" == typeof d.onStart && d.onStart(d), d.keepAlive && o(), a = setTimeout(function() { "function" != typeof d.onWarn ? e("#session-timeout-dialog").modal("show") : d.onWarn(d), n() }, d.warnAfter) }

        function n() { 
            clearTimeout(a), e("#session-timeout-dialog").hasClass("in") || !d.countdownMessage && !d.countdownBar || s("dialog", !0), a = setTimeout(function() { "function" != typeof d.onRedir ? window.location = d.redirUrl : d.onRedir(d) }, d.redirAfter - d.warnAfter) }
